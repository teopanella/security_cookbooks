...
wget <%=node['nessus_cloud']['download']%>/Nessus_amazon_64.deb --no-check-certificate --quiet
mv Nessus_amazon_64.deb /tmp/Nessus_amazon_64.deb
dpkg -i /tmp/Nessus_amazon_64.deb
sleep 30
rm /tmp/Nessus_amazon_64.deb
